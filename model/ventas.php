    ...
    public function Crear(Ventas $data, array $productos, array $servicios) {
        try {
            ...
            $stmtVenta->execute([
                ...
                ':id_usuario' => $data->id_usuario_vendedor,
            ...
            foreach ($servicios as $serv) {
                ...
                $stmtDetalle->execute([
                    ...
                    ':cant' => $serv['cantidad'],
                    ':precio' => $serv['precio'],
                    ':total' => null, // Puedes ajustar esto si necesitas calcularlo
                    ':fecha' => null // Puedes ajustar esto si necesitas guardarlo
                ]);
            }
